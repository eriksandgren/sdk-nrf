...
{
	common_remote_capabilities_cb(conn, status, params);
...
BT_SCAN_CB_INIT(scan_cb, common_scan_filter_match, NULL, common_scan_connecting_error, common_scan_connecting);
