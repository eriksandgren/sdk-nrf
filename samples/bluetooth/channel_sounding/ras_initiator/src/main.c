...
#if defined(CONFIG_RAS_INITIATOR_STEP_MODE_2_SUB_MODE_1)
#define CS_CONFIG_MODE BT_CONN_LE_CS_MAIN_MODE_2_SUB_MODE_1
#elif defined(CONFIG_RAS_INITIATOR_STEP_MODE_2)
#define CS_CONFIG_MODE BT_CONN_LE_CS_MAIN_MODE_2_NO_SUB_MODE
#elif defined(CONFIG_RAS_INITIATOR_STEP_MODE_1)
#define CS_CONFIG_MODE BT_CONN_LE_CS_MAIN_MODE_1_NO_SUB_MODE
#elif defined(CONFIG_RAS_INITIATOR_STEP_MODE_3)
	...
	if (quality == CS_DE_QUALITY_OK) {
		for (uint8_t ap = 0; ap < cs_de_report.n_ap; ap++) {
			if (cs_de_report.tone_quality[ap] == CS_DE_TONE_QUALITY_OK ||
			    isfinite(cs_de_report.distance_estimates[ap].rtt)) {
				store_distance_estimates_in_buffer(
					&cs_de_report.distance_estimates[ap],
...
#if defined(CONFIG_RAS_INITIATOR_STEP_MODE_1)
...
#elif defined(CONFIG_RAS_INITIATOR_STEP_MODE_2_SUB_MODE_1) ||                                      \
	defined(CONFIG_RAS_INITIATOR_STEP_MODE_3)
